...
export const Pagination = ({handleNextPage ,handlePreviosPage,pagePre ,pageNext ,page }) => {
  return (
   ...
   <Text fontSize="22px" fontWeight="400"><ChevronLeftIcon fontSize="26px" ml="-8px" p="0"/>Prev</Text></Button>
    ...
    <Button colorScheme="telegram" onClick={()=>handleNextPage(1)} isLoading={pageNext} isDisabled={page == 3}  ml="3" mr={{base:"0px", sm: "20px", md: "30px", lg: "30px",xl: "30px",'2xl': "30px"}} pl={{base:"10px", sm: "10px", md: "10px", lg: "10px",xl: "10px",'2xl': "10px"}} pr={{base:"5px", sm: "2px", md: "2px", lg: "2px",xl: "2px",'2xl': "2px"}}  > 
